...
8. In the text box, enter prompts to find commonalities between the two articles, such as _Synthesize the two interviews_ or _Identify common themes from both interviews._ Prompts can also depend on the insights you are looking for; a more specific example could be “Identify common approaches to balancing livelihoods and creativity among both artists interviewed.
